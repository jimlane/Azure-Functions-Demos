...
The application utilizes three separate JS based Azure Functions to provide application API's. The chat client (index.html) is a JS SPA located in the [content](/content/) folder. The client depends upon the following settings:
